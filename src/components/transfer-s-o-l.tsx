    ...
    <div className='h-full w-full rounded-lg bg-white/10 p-4 shadow-lg'>
      ...
      <form onSubmit={handleTransfer} className='flex flex-col gap-4'>
        ...
        <button
          ...
          className='w-full rounded-md bg-gradient-to-r from-purple-300 to-purple-200 px-4 py-2 font-bold text-black shadow-lg transition duration-200 hover:scale-101 disabled:cursor-not-allowed disabled:opacity-50'
        >
